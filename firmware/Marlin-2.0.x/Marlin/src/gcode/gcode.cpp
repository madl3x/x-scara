...
void GcodeSuite::process_parsed_command(const bool no_ok/*=false*/) {
  ...
  switch (parser.command_letter) {
    ...
    case 'M': switch (parser.codenum) {
      ...
      #if ENABLED(X_SCARA)
        case 360: M360(); break;                                  // M360: X-SCARA Change coordinate transformation mode
        case 361: M361(); break;                                  // M361: X-SCARA Move joints to position
        case 362: M362(); break;                                  // M362: X-SCARA Set current joints position
        case 363: M363(); break;                                  // M363: X-SCARA Configure
        case 364: M364(); break;                                  // M364: X-SCARA Get version
      #endif
      ...
      #if ENABLED(DELTA) || ENABLED(IS_SCARA)
